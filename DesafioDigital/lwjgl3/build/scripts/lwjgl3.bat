...
set CLASSPATH=%APP_HOME%\lib\DesafioDigital-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" com.badlogic.desafiodigital.lwjgl3.Lwjgl3Launcher %*
